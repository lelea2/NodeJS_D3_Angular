...
<html lang="en">
<head>
    <title>Code coverage report for util/util.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">util/util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">util/</a> &#187; util.js</div>
</div>
<div class="body">
...
<span class="cstat-skip" title="statement not covered" >            resultDate = new Date().addDays(numDay);</span>
        }
        return resultDate;
    }
&nbsp;
...
&nbsp;
    ...
    function cloneObj(obj) {
        ...
        for (var i in obj) {
            ...
            <span class="skip-if-branch" title="else path not taken" >E</span>if (obj.hasOwnProperty(i)) {
                target[i] = obj[i];
            }
        }
        return target;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jul 27 2015 12:53:53 GMT-0700 (PDT)</div>
</div>
