...
<html lang="en">
<head>
    <title>Code coverage report for logger/logger.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">logger/logger.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">logger/</a> &#187; logger.js</div>
</div>
<div class="body">
...
<span class="skip-if-branch" title="else path not taken" >E</span>if (process.env.NODE_ENV === 'production') {
